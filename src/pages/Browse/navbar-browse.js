        ...
        <div className="flex items-center md:flex-col xl:mt-[-30px] lg:mt-[-20px]">
          ...
          <div>
            <ul className="flex items-center justify-center gap-6 md:flex-col md:my-6">
              <li className="w-16 font-semibold text-pink-800 transition-all cursor-pointer text-md md:text-xl sm:text-lg md:hover:text-xl lg:text-2xl 2xl:text-3xl 2xl:hover:text-3xl lg:hover:text-2xl hover:text-lg">
                Browse
              </li>
              <li className="w-16 text-sm transition-all opacity-50 cursor-pointer hover:opacity-100 sm:text-md lg:text-lg 2xl:text-xl hover:text-lg lg:hover:text-xl 2xl:hover:text-2xl">
                Favorite
              </li>
            </ul>
          </div>
